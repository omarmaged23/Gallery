<div class="card my-4" style="border: none; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <textarea class="form-control" name="description" id="description" cols="30" rows="5" placeholder="Description" style="resize:none;" required>Description</textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input class="form-control" type="file" id="myFile" name="filename" accept=".jpg,.jpeg,.png,.mp4,.oog" required>
            </div>
